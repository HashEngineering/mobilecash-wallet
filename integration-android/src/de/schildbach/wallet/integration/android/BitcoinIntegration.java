...
public final class BitcoinIntegration
{
	...
	private static final String MIMETYPE_PAYMENTREQUEST = "application/mobilecash-paymentrequest"; // BIP 71
	...
	{
		Toast.makeText(context, "No MobileCash application found.\nPlease install MobileCash Wallet.", Toast.LENGTH_LONG).show();
